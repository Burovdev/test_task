...
export const ProofNeededIcon: FC<IconProp> = ({ className, height, width, color = "currentColor" }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const NoProofIcon: FC<IconProp> = ({ className, height, width, color = "currentColor" }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const CheckMarkIcon: FC<IconProp> = ({ className, height, width, color = "currentColor" }) => {
    return (
...
export const CloseIcon: FC<IconProp> = ({ className, height, width, color = "currentColor" }) => {
    return (
        <svg className={className} width={width} height={height} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
                fill={color}
